...
var app = (function () {
    ...
    class Social extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { social: 0 });
    ...
    function create_fragment$1(ctx) {
    	...
    	let span2;
    	let t9;
    	let t10_value = /*profile*/ ctx[0].age + "";
    	let t10;
    	let t11;
    	let span3;
    	let a0;
    	let t12_value = /*profile*/ ctx[0].email + "";
    	let t12;
    	let a0_href_value;
    	let t13;
    	let span4;
    	let a1;
    	let t14_value = /*profile*/ ctx[0].phone + "";
    	let t14;
    	let a1_href_value;
    	let t15;
    	let span5;
    	let t16_value = /*profile*/ ctx[0].location.city + "";
    	let t16;
    	let t17;
    	let t18_value = /*profile*/ ctx[0].location.country + "";
    	let t18;
    	let t19;
    	let social_1;
    	let current;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span0, "class", "profile__info__name svelte-1erfujl");
    			add_location(span0, file$1, 9, 8, 183);
    			attr_dev(span1, "class", "profile__info__aboutme svelte-1erfujl");
    			add_location(span1, file$1, 12, 8, 305);
    			attr_dev(div0, "class", "profile__info__container svelte-1erfujl");
    			add_location(div0, file$1, 8, 4, 136);
    			attr_dev(img, "class", "profile__image svelte-1erfujl");
    			if (!src_url_equal(img.src, img_src_value = './build/assets/user.png')) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Muhtalip Dede - Software Engineer");
    			add_location(img, file$1, 16, 8, 484);
    			attr_dev(span2, "class", "svelte-1erfujl");
    			add_location(span2, file$1, 21, 8, 639);
    			attr_dev(a0, "href", a0_href_value = "mailto:" + /*profile*/ ctx[0].email);
    			attr_dev(a0, "class", "svelte-1erfujl");
    			add_location(a0, file$1, 23, 12, 698);
    			attr_dev(span3, "class", "svelte-1erfujl");
    			add_location(span3, file$1, 22, 8, 679);
    			attr_dev(a1, "href", a1_href_value = "tel:" + /*profile*/ ctx[0].phone);
    			attr_dev(a1, "class", "svelte-1erfujl");
    			add_location(a1, file$1, 26, 12, 794);
    			attr_dev(span4, "class", "svelte-1erfujl");
    			add_location(span4, file$1, 25, 8, 775);
    			attr_dev(span5, "class", "svelte-1erfujl");
    			add_location(span5, file$1, 28, 8, 868);
    			attr_dev(div1, "class", "profile__image__container svelte-1erfujl");
    			add_location(div1, file$1, 14, 4, 382);
    			attr_dev(div2, "class", "profile svelte-1erfujl");
    			add_location(div2, file$1, 7, 0, 110);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div1, t19);
    			mount_component(social_1, div1, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			if ((!current || dirty & /*profile*/ 1) && t0_value !== (t0_value = /*profile*/ ctx[0].name + "")) set_data_dev(t0, t0_value);
    			if ((!current || dirty & /*profile*/ 1) && t2_value !== (t2_value = /*profile*/ ctx[0].surname + "")) set_data_dev(t2, t2_value);
    			if ((!current || dirty & /*profile*/ 1) && t4_value !== (t4_value = /*profile*/ ctx[0].title + "")) set_data_dev(t4, t4_value);
    			if ((!current || dirty & /*profile*/ 1) && t6_value !== (t6_value = /*profile*/ ctx[0].aboutme + "")) set_data_dev(t6, t6_value);
    			if ((!current || dirty & /*profile*/ 1) && t10_value !== (t10_value = /*profile*/ ctx[0].age + "")) set_data_dev(t10, t10_value);
    			if ((!current || dirty & /*profile*/ 1) && t12_value !== (t12_value = /*profile*/ ctx[0].email + "")) set_data_dev(t12, t12_value);

    			if (!current || dirty & /*profile*/ 1 && a0_href_value !== (a0_href_value = "mailto:" + /*profile*/ ctx[0].email)) {
    				attr_dev(a0, "href", a0_href_value);
    			}

    			if ((!current || dirty & /*profile*/ 1) && t14_value !== (t14_value = /*profile*/ ctx[0].phone + "")) set_data_dev(t14, t14_value);

    			if (!current || dirty & /*profile*/ 1 && a1_href_value !== (a1_href_value = "tel:" + /*profile*/ ctx[0].phone)) {
    				attr_dev(a1, "href", a1_href_value);
    			}

    			if ((!current || dirty & /*profile*/ 1) && t16_value !== (t16_value = /*profile*/ ctx[0].location.city + "")) set_data_dev(t16, t16_value);
    			if ((!current || dirty & /*profile*/ 1) && t18_value !== (t18_value = /*profile*/ ctx[0].location.country + "")) set_data_dev(t18, t18_value);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		...
    		if (social === undefined && !('social' in $$props || $$self.$$.bound[$$self.$$.props['social']])) {
    			console.warn("<Profile> was created without expected prop 'social'");
    		}
    	});

    	const writable_props = ['profile', 'social'];
    	...
    	$$self.$capture_state = () => ({ Social, profile, social });
    ...
    class Profile extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { profile: 0, social: 1 });
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = text(" - ");
    			t6 = text(t6_value);
    			attr_dev(span0, "class", "title svelte-1omr14z");
    			add_location(span0, file$2, 8, 12, 158);
    			attr_dev(span1, "class", "date svelte-1omr14z");
    			add_location(span1, file$2, 9, 12, 230);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-1omr14z");
    			add_location(span, file$2, 5, 4, 76);
    			attr_dev(div0, "class", "svelte-1omr14z");
    			add_location(div0, file$2, 6, 4, 105);
    			attr_dev(div1, "class", "experience svelte-1omr14z");
    			add_location(div1, file$2, 4, 0, 47);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Experience extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { experience: 0 });
    ...
    const file$3 = "src/components/Education.svelte";
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t7 = text(" - ");
    			t8 = text(t8_value);
    			attr_dev(span0, "class", "title svelte-rxi4r1");
    			add_location(span0, file$3, 8, 12, 153);
    			attr_dev(span1, "class", "description svelte-rxi4r1");
    			add_location(span1, file$3, 9, 12, 230);
    			attr_dev(span2, "class", "date svelte-rxi4r1");
    			add_location(span2, file$3, 10, 12, 294);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span0, anchor);
    			append_dev(span0, t0);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-rxi4r1");
    			add_location(span, file$3, 5, 4, 74);
    			attr_dev(div0, "class", "svelte-rxi4r1");
    			add_location(div0, file$3, 6, 4, 101);
    			attr_dev(div1, "class", "education svelte-rxi4r1");
    ...
    class Education extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { education: 0 });
    ...
    const file$4 = "src/components/Award.svelte";
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			attr_dev(span, "class", "svelte-1tgrfx8");
    			add_location(span, file$4, 8, 34, 163);
    			attr_dev(a, "href", a_href_value = /*award*/ ctx[1].url);
    			attr_dev(a, "class", "svelte-1tgrfx8");
    			add_location(a, file$4, 8, 12, 141);
    			attr_dev(div, "class", "svelte-1tgrfx8");
    			add_location(div, file$4, 7, 8, 123);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-1tgrfx8");
    			add_location(span, file$4, 5, 4, 67);
    			attr_dev(div, "class", "award svelte-1tgrfx8");
    ...
    class Award extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { awards: 0 });
    ...
    function create_each_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			t = text(t_value);
    			attr_dev(span, "class", "title svelte-1ddnd7w");
    			add_location(span, file$5, 8, 12, 156);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-1ddnd7w");
    			add_location(span, file$5, 5, 4, 73);
    			attr_dev(div0, "class", "svelte-1ddnd7w");
    			add_location(div0, file$5, 6, 4, 100);
    			attr_dev(div1, "class", "language svelte-1ddnd7w");
    ...
    class Language extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { languages: 0 });
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			t = text(t_value);
    			attr_dev(span, "class", "stack svelte-1vfi96w");
    			add_location(span, file$6, 12, 20, 392);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t);
    ...
    function create_each_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = space();
    			attr_dev(span0, "class", "title svelte-1vfi96w");
    			add_location(span0, file$6, 8, 12, 151);
    			attr_dev(span1, "class", "description svelte-1vfi96w");
    			add_location(span1, file$6, 9, 12, 225);
    			attr_dev(div, "class", "stack__container svelte-1vfi96w");
    			add_location(div, file$6, 10, 12, 292);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span0, anchor);
    			append_dev(span0, t0);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-1vfi96w");
    			add_location(span, file$6, 5, 4, 71);
    			attr_dev(div0, "class", "svelte-1vfi96w");
    			add_location(div0, file$6, 6, 4, 97);
    			attr_dev(div1, "class", "project svelte-1vfi96w");
    			add_location(div1, file$6, 4, 0, 45);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Project extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { projects: 0 });
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	return [profile, social, experience, education, projects, awards, languages];
    }
